...
-- Spring Curves
hl.curve("spring_menu", { type = "spring", mass = 1, stiffness = 60, dampening = 14 })
...
hl.animation({ leaf = "workspaces", enabled = true, speed = 7, spring = "spring_workspace", style = "slide" })
hl.animation({ leaf = "specialWorkspace", enabled = true, speed = 3, spring = "spring_special", style = "slidefadevert 40%" })
